...
public class FaceRecogntionUI {
    ...
    private static final Logger log = LogManager.getLogger(FaceRecogntionUI.class);
    ...
    private void addSignature() {
        JLabel signature = new JLabel("dbx", SwingConstants.CENTER);
